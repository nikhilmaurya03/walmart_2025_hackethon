...
var DataRouterContext = K(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = K(null);
DataRouterStateContext.displayName = "DataRouterState";
var ViewTransitionContext = K({
  isTransitioning: false
});
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = K(
  /* @__PURE__ */ new Map()
);
FetchersContext.displayName = "Fetchers";
var AwaitContext = K(null);
AwaitContext.displayName = "Await";
var NavigationContext = K(
  null
);
NavigationContext.displayName = "Navigation";
var LocationContext = K(
  null
);
...
function Await({
  ...
  return _(AwaitErrorBoundary, { resolve, errorElement }, _(ResolveAwait, null, children));
}
...
function Links() {
  ...
  return _(k, null, typeof criticalCss === "string" ? _("style", { dangerouslySetInnerHTML: { __html: criticalCss } }) : null, typeof criticalCss === "object" ? _("link", { rel: "stylesheet", href: criticalCss.href }) : null, keyedLinks.map(
    ({ key, link }) => isPageLinkDescriptor(link) ? _(PrefetchPageLinks, { key, ...link }) : _("link", { key, ...link })
  ));
}
function PrefetchPageLinks({
  ...
  return _(PrefetchPageLinksImpl, { page, matches, ...dataLinkProps });
}
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  return isHydrated ? null : _(k, null, typeof manifest.sri === "object" ? _(
    "script",
    {
      "rr-importmap": "",
      type: "importmap",
...
function createRoutesStub(routes, unstable_getContext) {
  return function RoutesTestStub({
    ...
    return _(FrameworkContext.Provider, { value: remixContextRef.current }, _(RouterProvider, { router: routerRef.current }));
  };
}
...
function HydratedRouter(props) {
  ...
  let [location, setLocation] = d(router.state.location);
  _2(() => {
  ...
  return (
    ...
    _(k, null, _(
      ...
      _(RemixErrorBoundary, { location }, _(RouterProvider2, { router }))
    ), _(k, null))
  );
}
export {
